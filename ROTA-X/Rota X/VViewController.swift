...
//  UberCarAnimationCLLocationManagerDelegate
//
...
class VViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate{
  ...
  override func viewDidLoad() {
    ...
    mp.delegate = self as! MKMapViewDelegate
    setup()
